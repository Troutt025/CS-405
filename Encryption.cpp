...
std::string read_file(const std::string & filename)
{
	...
	// filestream for reading file
	std::ifstream ifstream(filename);

	// assigning file contents to string
	file_text.assign((std::istreambuf_iterator<char>(ifstream)), (std::istreambuf_iterator<char>()));
...
void save_data_file(const std::string & filename, const std::string & student_name, const std::string & key, const std::string & data)
{
	...
	// setting timestamp
	std::strftime(timestamp, sizeof(timestamp), "%Y-%m-%d", &timeStruct);

	// opening file stream
	std::ofstream ofstream(filename);

	// writing data to file
	ofstream << student_name << std::endl;
	ofstream << timestamp << std::endl;
	ofstream << key << std::endl;
	ofstream << data << std::endl;
